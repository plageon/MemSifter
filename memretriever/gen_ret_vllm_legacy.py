...
def process_haystack_sessions(tokenizer: Any, entry: Dict, max_content_length: int = 65536):
    ...
    for turn in kept_turns:
        ...
        all_turn_token_ids.append(turn['input_ids'])
...
async def main(api_request_semaphore: asyncio.Semaphore, dataset_name: str, output_dir: str, split: str, embed_model: str, model_path: str, max_content_length: int):
